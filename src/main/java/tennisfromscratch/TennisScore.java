...
public enum TennisScore {
    ...
    FortyFifteen("Forty-Fifteen"),
    FifteenForty("Fifteen-Forty"),
    FifteenThirty("Fifteen-Thirty",FifteenForty,FifteenForty),
    ThirtyFifteen("Thirty-Fifteen",FortyFifteen,FortyFifteen),
